...
// // REORDERED: Analytics first (overview) → Sales → Inventory → Customers → Operations → Settings
...
//     ],
//     action: 'Let\'s see how to record these sales',
//     path: '/dashboard',
//   },
...
//     ],
//     action: 'Now let\'s record your first sale',
...
//       '🔄 Repeat customers auto-appear in dropdown',
//       '⚠️ Cannot use "Walk-in"—use actual names'
//     ],
//     action: 'Repeat customers will show up here',
//   },
...
//     ],
//     action: 'Let\'s manage your inventory',
...
//   }, [step, isLast, isFirst, goNext, goPrev, onClose]);
